...
class Baraja {
    ...
    public function __construct() {
        $this->conjunto_cartas = [
            ...
            'carta_girada.png',
            'color_changer.png', 'picker_blue.png', 'picker_green.png', 'picker_red.png', 'picker_yellow.png',
            'reverse_blue.png', 'reverse_green.png', 'reverse_red.png', 'reverse_yellow.png',
