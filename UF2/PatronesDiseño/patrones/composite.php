...
<body class="bodyComposite">
    ...
    <div class="d-flex flex-column espacio as">
        <div class="d-flex justify-content-center">
            <h1 class="d-flex justify-content-center text-light mt-5 bordeComposite">Patrón - Composite</h1> 
        </div>

        <div class="d-flex justify-content-center espaciado">
            <p class="text-light dfl">El Patrón Composite es un patrón de diseño estructural que permite tratar objetos individuales y composiciones de objetos de la misma manera. Es útil cuando trabajas con estructuras jerárquicas, como árboles o gráficos.</p>
        </div>
    </div>     
