...
<body class="bodyFactory">
    ...
    <div class="d-flex flex-column espacio as">
        <div class="d-flex justify-content-center">
            <h1 class="d-flex justify-content-center text-light mt-5 bordeAbstract">Patron - Abstract Factory</h1> 
        </div>

        <div class="d-flex justify-content-center espaciado">
            <p class="text-light dfl">El Patrón Abstract Factory es un patrón de diseño creacional que permite crear familias de objetos relacionados sin especificar sus clases concretas. Es una extensión del Factory Method, pero en lugar de producir un solo tipo de objeto, proporciona una fábrica que crea múltiples tipos de objetos interrelacionados.</p>
        </div>
    </div>     
