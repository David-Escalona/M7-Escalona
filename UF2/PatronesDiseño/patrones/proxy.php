...
<body class="bodyAdapter">
    ...
    <div class="d-flex flex-column espacio as">
        <div class="d-flex justify-content-center">
            <h1 class="d-flex justify-content-center text-light mt-5 bordeProxy">Patrón - Proxy</h1> 
        </div>

        <div class="d-flex justify-content-center espaciado">
            <p class="text-light dfl">El Patrón Proxy es un patrón de diseño estructural que actúa como un sustituto o intermediario para otro objeto. Se usa para controlar el acceso a dicho objeto, agregando una capa adicional de funcionalidad, como control de permisos, carga diferida o registro de acciones.</p>
        </div>
    </div>     
