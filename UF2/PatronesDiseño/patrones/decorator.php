...
<body class="bodyDecorator">

    <main>

    <div class="d-flex flex-column espacio as">
        <div class="d-flex justify-content-center">
            <h1 class="d-flex justify-content-center text-light mt-5 bordeDecorator">Patron - Decorator</h1> 
        </div>

        <div class="d-flex justify-content-center espaciado">
            <p class="text-light dfl">El Patrón Decorator es un patrón de diseño estructural que permite añadir funcionalidades a un objeto de manera dinámica, sin modificar su código fuente ni usar herencia excesiva. Se usa cuando quieres extender el comportamiento de objetos sin alterar su estructura.</p>
        </div>
    </div>     
